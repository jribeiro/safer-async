    ...
    var internals = {
        ...
        wrapTask: function wrapTask (task) {
            ...
            return function wrappedTask (callback, results) {
                ...
                if (counter === 1) {
                    internals.options.errorCB('Error in task: ' + task.name + ' - Function called multiple times. Aborting');
                }
        ...
        wrapCB: function wrapCB (task, callback) {
            ...
            return function wrappedCallback (error, params) {
                ...
                if (counter === 1) {
                    internals.options.errorCB('Error in task: ' + task.name + ' - Callback called multiple times. Aborting');
                }
